...
begin
  ...
  procedure TForm1.FormCreate(Sender: TObject);
   ...
   dfIniFile:=TIniFile.create(sIniFileName);
      ...
      dfIniFile.WriteString('chips','0','Sensor Dwór');
 ...
 begin
   ...
   begin
    StatusBar1.Panels[0].Text := '  Nie mo¿na za³adowaæ sterownika.';
    Exit;
   end;
  ...
  begin
   ...
   sTmp:=dfIniFile.ReadString('chips','0','xx');
    if not boIDValid(sTmp) then
     begin
      showmessage('Sensor Dwór Nieaktualny.');
      application.terminate;
     end;
      saDMLRomID[0]:=sTmp;
         ...
         portwriteb($378,$0);
          ...
          begin
            ...
            if ( C = z3 ) or ( C = z13) or ( C = z123) or ( C = z23) or ( C = z34) or ( C = z234) or ( C = z134) or ( C = z1234) then
             ...
             Form2.Brak.Lines.Add('Pêtla_ok _');
             Form8.Brak.Lines.Add('Pêtla_ok _');
             Break;
             end;
            end;
        ...
        portwriteb($378,$0);
          ...
          begin
            ...
            if ( C = z3 ) or ( C = z13) or ( C = z123) or ( C = z23) or ( C = z34) or ( C = z234) or ( C = z134) or ( C = z1234) then
             ...
             Form2.Brak.Lines.Add('Pêtla_ok_');
             Form8.Brak.Lines.Add('Pêtla_ok_');
             Break;
             end;
            end;
...
begin
   ...
   begin
     ...
     begin
      ...
      Form2.Brak.Lines.Add('Zamkniêty_Awaryjnie_2' + #13#10);
      Form8.Brak.Lines.Add('<span style="color:' + kolor_alarm + ';">Zamkniêty_Awaryjnie_2</span></span>..' + #13#10)
      end else
      begin
      Form2.Brak.Lines.Add(Data + ' ' + Czas3);
      Form8.Brak.Lines.Add('<span style="color:' + kolor_kominek + ';">' + Data + ' ' + Czas3 + '.');
  ...
  if (ruznica2 <= -histereza) and (ruznica1 > 0) and (piec_c > granica) and (czek1 = 'ON') and ((piec_c - stp) < 20) then
   begin
	...
	if ( C = z1 ) or ( C = z12 ) or ( C = z13 ) or ( C = z123 ) or ( C = z14 ) or ( C = z124 ) or ( C = z134 ) or ( C = z1234 ) then
	  begin
        Stan4:= 'Brak_zejscia_z_czujnika_odkrêcanie';
        Label18.Caption:= Stan4;
	    PlaySound('Alarm2.wav', 0, SND_FILENAME);
		Form2.Brak.Lines.Add(Data + ' ' + Czas3);
    ...
    Form2.Brak.Lines.Add('Brak_zejscia_z_czujnika_odkrêcanie' + #13#10);
    Form8.Brak.Lines.Add('<span style="color:' + kolor_alarm + ';">Brak_zejscia_z_czujnika_odkrêcanie</span></span>..' + #13#10);
	  end else
    begin
     Stan4:= ' ';
     Label18.Caption:= Stan4;
     ...
     Form2.Brak.Lines.Add('Zejscie_z_czujnika_odkrêcanie. ');
     Form8.Brak.Lines.Add('Zejscie_z_czujnika_odkrêcanie. ');
	    for s:=0 to 80 do
      begin
			portwriteb($378,$1);
      bar := bar + 1; ProgressBar2.Position := bar;
      ...
      bar := bar + 1; ProgressBar2.Position := bar;
       ...
       begin
       Form2.Brak.Lines.Add('Pêtla_ok_odkrêcanie' + #13#10);
       Form8.Brak.Lines.Add('Pêtla_ok_odkrêcanie</span>..' + #13#10);
       licz_o := licz_o + 1;
       licz_z := 0;
       Break;
       end;
	 ...
	 begin
      if obraz = 0 then
        begin
	     ...
	     Stan2:= 1;
         Stan2s:= '&#8593;!';
         Form2.Brak.Lines.Add('Odkrêcanie_Error' + #13#10);
         Form8.Brak.Lines.Add('<span style="color:' + kolor_alarm + ';">Odkrêcanie_Error</span></span>..' + #13#10);
        end else
        begin
 ...
 begin
	...
	begin
	 SleepTime:=(60);
	  ...
	  if ( C = z1 ) or ( C = z12 ) or ( C = z13 ) or ( C = z123 ) or ( C = z14 ) or ( C = z124 ) or ( C = z134 ) or ( C = z1234 ) then
    begin
        Stan4:= 'Brak_zejscia_z_czujnika_przykrêcanie';
        Label18.Caption:= Stan4;
		    PlaySound('Alarm2.wav', 0, SND_FILENAME);
        Form2.Brak.Lines.Add(Data + ' ' + Czas3);
        Form8.Brak.Lines.Add('<span style="color:' + kolor_podloga + ';">' + Data + ' ' + Czas3 + '.');
    ...
    begin
         ...
         Form2.Brak.Lines.Add('Zejscie_z_czujnika_przykrêcanie. ');
         Form8.Brak.Lines.Add('Zejscie_z_czujnika_przykrêcanie. ');
         for s:=0 to 80 do
	      ...
	      begin
            ...
            if ( B = z1 ) or ( B = z12 ) or ( B = z13 ) or ( B = z123 ) or ( B = z14 ) or ( B = z124 ) or ( B = z134 ) or ( B = z1234 ) then
            begin
            Form2.Brak.Lines.Add('Pêtla_ok_przykrêcanie' + #13#10);
            Form8.Brak.Lines.Add('Pêtla_ok_przykrêcanie</span>..' + #13#10);
            licz_z := licz_z + 1;
            licz_o := 0;
            Break;
	          end;
	      ...
	      begin
           if obraz = 0 then
             begin
	          ...
	          Stan2:= 3;
            Stan2s:= '&#8595;!';
            Form2.Brak.Lines.Add('Przykrêcanie Error' + #13#10);
            Form8.Brak.Lines.Add('<span style="color:' + kolor_alarm + ';">Przykrêcanie Error</span>..' + #13#10);
             end else
             begin
  ...
  Form2.Brak.Lines.Add('Odkrêcanie_15x_Podloga_OFF' + #13#10);
  Form8.Brak.Lines.Add('<span style="color:' + kolor_alarm + ';">Odkrêcanie_15x_Podloga_OFF</span></span>..' + #13#10);
  czek1 := 'OFF';
  licz_o := 0;
  end;
  ...
  Form2.Brak.Lines.Add('Przykrêcanie_15x_Podloga_OFF' + #13#10);
  Form8.Brak.Lines.Add('<span style="color:' + kolor_podloga + ';">Przykrêcanie_15x_Podloga_OFF</span></span>..' + #13#10);
  czek1 := 'OFF';
  licz_z := 0;
  end;
  ...
  if Pos('Brak_zejscia_z_czujnika_odkrêcanie', Form8.Brak.Lines.Strings[sp]) > 0 then text_error := text_error + Form8.Brak.Lines[sp];
  if Pos('Odkrêcanie_Error', Form8.Brak.Lines.Strings[sp]) > 0 then text_error := text_error + Form8.Brak.Lines[sp];
  if Pos('Brak_zejscia_z_czujnika_przykrêcanie', Form8.Brak.Lines.Strings[sp]) > 0 then text_error := text_error + Form8.Brak.Lines[sp];
  if Pos('Przykrêcanie Error', Form8.Brak.Lines.Strings[sp]) > 0 then text_error := text_error + Form8.Brak.Lines[sp];
  ...
  HTML := '<html><head><title>Marek Bartocha</title></head><body><head><meta http-equiv="Refresh" content="180" /></head>' +
          ...
          '<div style="position: absolute; left: 345px;"><img src="domek.jpg" width="880" alt="Aktualizuje siê" /></div>' +
  ...
  HTML := '<html><head><title>Marek Bartocha</title></head><body><head><meta http-equiv="Refresh" content="180" /></head>' +
          ...
          '<div style="position: absolute; left: 345px;"><img src="domek_noc.jpg" width="880" alt="Aktualizuje siê" /></div>' +
          '<div style="position: absolute; left: 550px; top:100px"><a style="color: white" href="mbdzien.html"><big><big><big>Kolor Dzieñ</big></big></big></a></div>' +
 ...
 if obraz = 0 then
  ...
  begin
   ...
   obraz:= 0;
    ...
    if wygaszanie2 = 3 then Label17.Caption:= 'Wygaœniête';
    end;
end;
...
begin
CanClose := MessageBox(Handle, 'Czy na pewno chcesz zamkn¹æ program?', 'PotwierdŸ', MB_ICONWARNING + MB_YESNO) = mrYes;
end;
